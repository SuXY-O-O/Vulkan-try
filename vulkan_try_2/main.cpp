...
private:
    ...
    void createGraphicsPipeline() {
        ...
        VkPipelineInputAssemblyStateCreateInfo inputAssembly_point{};
        inputAssembly_point.sType = VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO;
        inputAssembly_point.topology = VK_PRIMITIVE_TOPOLOGY_POINT_LIST;
        inputAssembly_point.primitiveRestartEnable = VK_FALSE;
